...
module.exports = class Viewer {
  ...
  reload() {
    ...
    this.ready = false;
    this.clearNavigationState();
    this.frame.src = `${this.pdfjsPath}?file=${encodeURIComponent(this.filePath)}${this.hash}`;
    this.updateTitle();
  }
