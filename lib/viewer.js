...
module.exports = class Viewer {
  ...
  toggleRefreshing() {
    ...
    if (this.autoRefresh) {
      lumine.notifications.addSuccess("pdf-view: Auto-refreshing activated in active file");
    } else {
      lumine.notifications.addSuccess("pdf-view: Auto-refreshing deactivated in active file");
    }
  }
